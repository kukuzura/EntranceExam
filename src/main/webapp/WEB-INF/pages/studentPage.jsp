    ...
    <table id="list">
        <c:choose>
            <c:when test="${empty examAndGradesMap}">
                ...
                <tr><a href="<c:url value="specialityList"/>"><spring:message code="studentPage.button.apply"/></a></tr>
            </c:when>
            <c:otherwise>
                <tr>${message}</tr>
                <tr>
...
<a href="<c:url value="/logout"/>"><spring:message code="studentPage.button.logout"/></a>
    <a href="<c:url value="/"/>"><spring:message code="studentPage.button.home"/></a>
        </div>
        </div>
        </label>
